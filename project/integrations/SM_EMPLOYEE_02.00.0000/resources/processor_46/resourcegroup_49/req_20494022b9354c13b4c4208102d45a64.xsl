   ...
   <oracle-xsl-mapper:schema xml:id="id_2">
      ...
      <oracle-xsl-mapper:mapTargets xml:id="id_7">
         <oracle-xsl-mapper:target type="WSDL" xml:id="id_8">
            <oracle-xsl-mapper:schema location="../../application_20/inbound_21/resourcegroup_38/atpSelectEmployee_REQUEST.wsdl" xml:id="id_9"/>
   ...
   <xsl:template match="/" xml:id="id_11">
      <nstrgmpr:atpSelectEmployeeSelect_employeeNumberInputParameters xml:id="id_12">
         <nstrgmpr:employeeNumber xml:id="id_21">
            <xsl:value-of xml:id="id_22" select="/nssrcmpr:execute/ns15:request-wrapper/ns15:EmployeeNumber"/>
